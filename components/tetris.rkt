...
(define (tetris #:on-start (on-start (const "")))
  (enclose
    (div
      (include-js "https://aerolab.github.io/blockrain.js/src/blockrain.jquery.libs.js")
      (include-js "https://aerolab.github.io/blockrain.js/src/blockrain.jquery.src.js")
      (include-js "https://aerolab.github.io/blockrain.js/src/blockrain.jquery.themes.js")
      (tetris-styles)
      (div id: (ns 'main) 
         style: (properties width: 250 height: 500))) 
    (script ([setup (call 'construct)])
      (function (construct)
        @js{$('@(id# 'main)').blockrain(
          {autoStart: true,
           onStart: ()=>{@(on-start)}})}
        ))))


(define (tetris-styles)
  @style/inline{
